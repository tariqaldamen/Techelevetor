...
FROM country
WHERE gnp * 1000000> 1000000000000
;
...
FROM country
WHERE GNP *1000000> 1000000000000 AND population < 100000000
;
...
FROM country 
WHERE GNP *1000000 BETWEEN 1000000 AND 100000000 AND lifeexpectancy >= 70
;
-- 21. The per capita GNP (i.e. GNP divided by population) in US Dollars of all countries in Europe (46 rows)
SELECT name , GNP *1000000/ population
FROM country 
